...
namespace SwarmSimulation
{
    public sealed class LineStretchingSimulation : BaseForm
    {
        ...
        private IAlgorithm<ProximityAlgorithmSettings, ProximityAlgorithmInput> _lineStretchingAlgorithm;
        ...
        protected override void InitializeSimulation()
        {
            ...
            _lineStretchingAlgorithm = new ProximityAlgorithm(algorithmSettings); 
        ...
        protected override void UpdateSimulation(object sender, EventArgs e)
        {
            ...
            _swarm.Disperse(_lineStretchingAlgorithm, input);
